...
export function VideoGrid() {
  ...
  const handleCloseUploadModal = (shouldRefresh: boolean) => {
            ...
            <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
              <div className="relative w-full md:w-64">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
        ...
        {isLoading || isRefreshing ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-400 text-lg">
              {searchQuery ? `No lectures found matching "${searchQuery}"` : "No lectures found for the selected filters"}
            </p>
            {lectures.length === 0 && (
              <button
                onClick={refreshLectures}
